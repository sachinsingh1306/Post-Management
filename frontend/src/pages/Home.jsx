    ...
    <div className="min-h-screen bg-slate-50/50">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          {/* Optional Sidebar-style Content Info */}
          <aside className="hidden lg:block w-72 shrink-0">
            <div className="sticky top-24 space-y-6">
              <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm">
                <h3 className="font-bold text-slate-900 mb-3">About the Feed</h3>
                <p className="text-sm text-slate-500 leading-relaxed">
                  Every post you see has been reviewed by our moderation team to ensure community standards are met.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-slate-900 to-slate-800 p-6 rounded-3xl text-white shadow-xl shadow-slate-200">
                ...
                <p className="text-xs text-slate-400 mb-4 leading-relaxed">
                  Join our growing community and share your unique perspective.
                </p>
                <button className="w-full py-2.5 bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl text-sm font-bold transition-all active:scale-95">
                  Write a Post
                </button>
              </div>
            </div>
